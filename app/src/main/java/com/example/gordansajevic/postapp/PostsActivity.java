...
import com.example.gordansajevic.postapp.singletons.PostFeed;
...
public class PostsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFilter = (EditText) findViewById(R.id.edit_text_email);
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint == null || constraint.length() == 0){
                    ...
                    for(int i=0; i<mListToShow.size(); i++){
                        ...
                        String postTitle = p.getmTitle().toLowerCase();
